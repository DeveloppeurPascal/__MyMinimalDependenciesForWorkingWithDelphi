...
REM
REM Ce projet utilise un accès SSL aux hébergements pour récupérer les dépôts dans un état modifiable sur mes ordinateurs. Des dépôts privés sont également récupérés de cette façon. Ce script ne fonctionnera pas chez vous.
